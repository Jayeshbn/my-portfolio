...
const Footer = () => {
    ...
    return (
        <div name="Contact" className='bg-gradient-to-t from-gray-800 via-black to-black  w-full  text-gray-300'>
            <div className="section pb-5">
                <div className="flex flex-wrap justify-between ">
                    <div className="w-full sm:w-3/5 lg:w-2/5 pr-2">
                        <h3 className='text-white text-[1.75rem] font-bold pb-2'>Jayesh B N</h3>
                        ...
                        <div className="flex flex-col sm:flex-row lg:flex-col  gap-5 xs:gap-10 sm:gap-5 md:gap-10 justify-between">
                            <div className='text-[0.9rem] font-advanced'>
                                <p className='flex items-center gap-3 mb-1'>
                                    <GMail /> <a href="mailto:jayeshbn10@gmail.com">jayeshbn10@gmail.com</a></p>
                                <p className='flex items-center gap-3 '> <Map /><span className="pt-1">Bangalore, Karnataka India</span></p>
                            </div>
