        ...
        <div name='About' className=' pt-8 h-full min-h-screen w-full flex items-center  bg-gradient-to-b to-black via-black from-gray-800 '>
            <div className='section justify-between'>
                ...
                <div className='mb-10  flex flex-col justify-center '>
                    <img src={profile} alt="Profile" width="auto" height="auto" loading='lazy' className='cursor-pointer grayscale hover:grayscale-0 hover:scale-[1.3] transition-all delay-75 border-1 border-transparent hover:border-white duration-500 rounded-2xl min-w-[240px] w-1/2 mx-auto  md:w-[270px]' />
                </div>
